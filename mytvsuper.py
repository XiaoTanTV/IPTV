...
CHANNEL_LIST = {
    'JUHD': {
        ...
        'logo': 'https://epg.112114.xyz/logo/翡翠台.png'  # 已更新
    },
    'J': {
        'name': '翡翠台',
    ...
    'P': {
        ...
        'logo': 'https://epg.112114.xyz/logo/明珠台.png'  # 已更新
    },
    'B': {
        'name': 'TVB Plus',
    ...
    'C': {
        ...
        'logo': 'https://epg.112114.xyz/logo/无线新闻.png'  # 已更新
    },
    'C3': {
        'name': '互動窗 1',
    ...
    'CTVE': {
        ...
        'logo': 'https://epg.112114.xyz/logo/娱乐新闻.png'  # 已更新
    },
    'TVG': {
        'name': '黃金翡翠台',
    ...
    'TVO': {
        ...
        'logo': 'https://epg.112114.xyz/logo/黄金华剧.png'  # 已更新
    },
    'CCOC': {
        'name': '戲曲台',
    ...
    'RKEX': {
        ...
        'logo': 'https://epg.112114.xyz/logo/RockExtreme.png'  # 在之前的列表中漏掉了，已根据MYTV列表补充
    }
}
